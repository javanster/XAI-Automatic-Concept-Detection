...
class ConceptClassifierScoreObtainer:
        ...
        with tqdm(total=total_len, unit="score") as pbar:
            for layer_index in layer_indexes:
                ...
                for concept in self.concepts:
                    ...
                    concept_activations_for_layer = ConceptClassifierScoreObtainer._get_activations(
                        model=activation_model_for_layer,
                        observations=observations_with_concept
                    )

                    non_concept_activations_for_layer = ConceptClassifierScoreObtainer._get_activations(
                        model=activation_model_for_layer,
