...
from data.custom_entity_positions import custom_positions
...
for i in range(3):
    observation_handler.show_observation(
        file_path="data/do_nothing_good_move_enemy_focused_observations.npy",
        observation_index=i
    )
